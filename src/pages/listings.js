      ...
      <div id="listing-rest">
        ...
        <div id="cards-section">
          <PropertiesCard
            ...
            bedrooms={cardproperties.bedrooms}
            bathrooms={cardproperties.bathrooms}
            squareFeet={cardproperties.squareFeet}
            mainAddress={cardproperties.mainAddress}
            streetAddress={cardproperties.streetAddress}
            duration={cardproperties.duration}
            owner={cardproperties.owner}
